...
public class PlayerService extends Service implements OnPreparedListener, OnErrorListener, OnCompletionListener {
	...
	//Intent commands
	public static final String INTENT_COMMAND = "no.samfunnet.nsr.playerservice.intent_command";
	public static final String INTENT_CALLBACK = "no.samfunnet.nsr.playerservice.intent_callback";
	//Callback keys
